...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 ...
                 scale=1.0, data_device = "cuda", depth_image = None, midas_conf=None,mask = None, bounds=None,
                 K=None, bds=None, mvs_depth=None,is_virtual=False):
